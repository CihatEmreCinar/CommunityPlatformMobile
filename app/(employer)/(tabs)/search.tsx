    ...
    <ScreenContainer edges={['top', 'bottom']} header={<Text style={styles.title}>Mekan Bul</Text>} scroll={false}>
      <View style={styles.content}>
        <View style={styles.filtersRow}>
          ...
          <View style={styles.filterInputWrapper}>
            <Text style={styles.filterLabel}>Min Kap.</Text>
            <TextInput
              style={styles.input}
              value={minCapacity}
        ...
        <View style={styles.filtersRow}>
          <View style={styles.filterInputWrapper}>
            <Text style={styles.filterLabel}>Max Kap.</Text>
            <TextInput
              style={styles.input}
              value={maxCapacity}
...
const styles = StyleSheet.create({
  ...
  filterInputWrapper: { flex: 1, gap: Spacing.xs },
  filterLabel: { ...Typography.labelSm, color: Colors.onSurfaceVariant },
  input: { backgroundColor: Colors.surfaceBright, borderRadius: Radius.full, paddingHorizontal: Spacing.md, paddingVertical: Spacing.sm, color: Colors.onSurface, borderWidth: 1, borderColor: Colors.surfaceVariant },
  searchButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: Spacing.xs, backgroundColor: Colors.primary, borderRadius: Radius.full, paddingHorizontal: Spacing.md, paddingVertical: Spacing.sm, minWidth: 108 },
