...
export default function EnrollmentsScreen() {
  ...
  return (
    <ScrollView
      ...
      refreshControl={
        <RefreshControl refreshing={isRefreshing} onRefresh={() => { setIsRefreshing(true); load(); }} colors={[Colors.primary]} />
      }
    >
  ...
  return (
    <View style={styles.card}>
      <View style={styles.cardHeader}>
        <Text style={styles.workshopTitle} numberOfLines={2}>{e.workshopTitle}</Text>
...
const styles = StyleSheet.create({
  ...
  pageTitle: { ...Typography.h1Mobile, color: Colors.onSurface, marginBottom: Spacing.lg },
